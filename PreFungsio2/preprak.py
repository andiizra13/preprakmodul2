...
# Telah disediakan sebuah struktur data global berupa list expenses yang akan digunakan untuk
# menyimpan daftar pengeluaran harian. Setiap pengeluaran akan direpresentasikan sebagai
# dictionary dengan atribut 'tanggal', 'deskripsi', dan 'jumlah'.
...
def view_expenses_report():
    ...
    for entry in generate_expenses_report():
        print(entry)
